        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <table id="myTable">
                    ...
                    <tbody>
                        @foreach ($configKendaraan as $config)
                            <tr>
                                <td>{{ $config->id }}</td>
                                <td>{{ $config->jenisKendaraan }}</td>
                                <td>{{ $config->biayaPerJam }}</td>
                                <td>{{ $config->maxBiaya }}</td>
                                <td><a href="{{ route('formConfigKendaraan', ['configId' => $config->id]) }}" class="btn btn-primary">
