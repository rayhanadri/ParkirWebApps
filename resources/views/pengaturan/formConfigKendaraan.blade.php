    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form method="POST" action="{{ route('prosesConfigKendaraan') }}">
                    @csrf
                    <div class="form-group">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ $configKendaraan->id }}
                                        <input type="hidden" name="id"
                                            value="{{ $configKendaraan->id }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" id="jenisKendaraan" name="jenisKendaraan"
                                            value="{{ $configKendaraan->jenisKendaraan }}">
                                    </td>
                                    <td><input type="text" class="form-control" id="biayaPerJam" name="biayaPerJam"
                                            value="{{ $configKendaraan->biayaPerJam }}"></td>
                                    <td><input type="text" class="form-control" id="maxBiaya" name="maxBiaya"
                                            value="{{ $configKendaraan->maxBiaya }}"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3 text-center">
                ...
                <a href="{{ route('configKendaraan') }}" class="btn btn-primary">
                    <h2 class="text-center"><i class="fa fa-arrow-left"></i><br>Kembali ke Config Jenis dan Biaya Kendaraan</h2>
                </a>
            </div>
        </div>
    </div>
