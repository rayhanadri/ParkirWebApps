...
<head>
    ...
    <title>Laporan Kendaraan Masuk Keluar</title>
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="text-center">Laporan Kendaraan Masuk Keluar</h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <h3 class="text-center">Detail Kendaraan Masuk Keluar</h3>
                <table id="myTable">
                    <thead>
                        <tr>
                            <th>Waktu Masuk</th>
                    ...
                    <tbody>
                        @foreach ($masukKeluarKendaraan as $masukKeluar)
                            <tr>
                                <td>{{ $masukKeluar->waktuMasuk }}</td>
                                <td>{{ $masukKeluar->waktuKeluar }}</td>
                                <td>{{ $masukKeluar->jenisKendaraan }}</td>
                                <td>{{ $masukKeluar->nomorPolisi }}</td>
                                <td>{{ $masukKeluar->jenisTiket }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3 text-center">
                <p>_____________________________________________________________</p>
                <a href="{{ route('kendaraanMasukKeluar') }}" class="btn btn-primary">
